...
public abstract class PlatformPage extends OnekeySharePage {
	...
	public void onCreate() {
		...
		lp.setMargins(0, 0, 0, 0);
		LinearLayout buttonLayoutView = new LinearLayout(activity);
		buttonLayoutView.setBackgroundColor(Color.WHITE);

		LinearLayout.LayoutParams lpLine = new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, 3);
		lpLine.setMargins(0, 0, 0, 0);
		View v = new View(activity);
		v.setBackgroundColor(android.graphics.Color.parseColor("#CCCCCC"));
		buttonLayoutView.addView(v, lpLine);
		llPanel.addView(buttonLayoutView, lp);
		...
		lp22.setMargins(20, 10, 20, 10);
		Button button2 = new Button(activity);
		button2.setText("取消分享");
		button2.setTextSize(16);
		button2.setTextColor(android.graphics.Color.parseColor("#a11c3f"));
