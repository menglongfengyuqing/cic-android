...
import com.ztmg.cicmorgan.more.adapter.FindIntegralShopAdapter.ViewHolder;
...
public class ActionCenterAdapter extends BaseAdapter {
    ...
    public ActionCenterAdapter(Context context, List<ActionCenterEntity> list) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = View.inflate(mContext, R.layout.item_action, null);
            ...
            //			holder.ll_tips = (LinearLayout) convertView.findViewById(R.id.ll_tips);
        ...
        //		}
        //		holder.ll_tips.setOnClickListener(new OnClickListener() {
        //
        //			@Override
