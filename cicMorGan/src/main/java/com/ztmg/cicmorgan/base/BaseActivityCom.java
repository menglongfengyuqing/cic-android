...
public abstract class BaseActivityCom extends FragmentActivity implements OkUtil.HttpCallback {
    ...
    protected void setTranslucentStatus(boolean on) {
        Window win = BaseActivityCom.this.getWindow();
