 ...
 * @author pc
 */
public class GoodsListActivity extends BaseActivity implements OnRefreshListener2<ListView>, AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            ...
            SystemBarTintManager tintManager = new SystemBarTintManager(GoodsListActivity.this);
        ...
        MobclickAgent.setScenarioType(GoodsListActivity.this, MobclickAgent.EScenarioType.E_UM_NORMAL);
    ...
    protected void initView() {
        ...
        setBack(new OnClickListener() {
            ...
            public void onClick(View v) {
                onEvent(GoodsListActivity.this, "404001_wdjp_back_click");
                finish();
            }
        });
        ...
        adapter = new GoodsListAdapter(GoodsListActivity.this, goodsTotalList);
    ...
    class SpinnerXMLSelectedListener implements AdapterView.OnItemSelectedListener {
        ...
        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
            onEvent(GoodsListActivity.this, "404003_wdjp_sxq_click");
            ...
            mBoolean_1 = true;
            getData("3", LoginUserProvider.getUser(GoodsListActivity.this).getToken(), pageNo, pageSize, REFRESH, awardGetType, isTrue);
        }
    ...
    private void getData(String from, String token, final int pageNo, int pageSize, final int RequestCode, String awardGetType, String isTrue) {
        ...
        client.post(url, params, new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                ...
                try {
                    ...
                    if (jsonObject.getString("state").equals("0")) {
                        ...
                        String mGesture = LoginUserProvider.getUser(GoodsListActivity.this).getGesturePwd();
                        if (mGesture.equals("1") && !mGesture.equals("") && mGesture != null) {// 判断是否设置手势密码
                            //设置手势密码
                            Intent intent = new Intent(GoodsListActivity.this, UnlockGesturePasswordActivity.class);
                        ...
                        DoCacheUtil util = DoCacheUtil.get(GoodsListActivity.this);
                        util.put("isLogin", "");

                    } else {
                        Toast.makeText(GoodsListActivity.this, jsonObject.getString("message"), 0).show();
                    }
                    lv_goods_list.onRefreshComplete();
                } catch (JSONException e) {
                    e.printStackTrace();
                    lv_goods_list.onRefreshComplete();
                    Toast.makeText(GoodsListActivity.this, "解析异常", 0).show();
                }
            }
            ...
            public void onFailure(int statusCode, org.apache.http.Header[] headers, byte[] responseBody,
                                  Throwable error) {
                lv_goods_list.onRefreshComplete();
                Toast.makeText(GoodsListActivity.this, "请检查网络", 0).show();
                //				CustomProgress.CustomDismis();
            }
        });
    }
    ...
    public void onPullUpToRefresh(PullToRefreshBase<ListView> refreshView) {
        getData("3", LoginUserProvider.getUser(GoodsListActivity.this).getToken(), pageNo + 1, pageSize, LOADMORE, awardGetType, isTrue);
    }

    @Override
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        onEvent(GoodsListActivity.this, "404002_wdjp_jplb_click");
        if (Lists.notEmpty(goodsTotalList)) {
            ...
            if (goodsListEntity.getIsTrue().equals("0")) {
                if (goodsListEntity.getState().equals("0") || goodsListEntity.getState().equals("1") || goodsListEntity.getState().equals("2")) {
                    Intent intent = new Intent(GoodsListActivity.this, OrderConfirmActivity.class);
                ...
                if (goodsListEntity.getState().equals("1")) {
                    Intent investmentIntent = new Intent(GoodsListActivity.this, MainActivity.class);
