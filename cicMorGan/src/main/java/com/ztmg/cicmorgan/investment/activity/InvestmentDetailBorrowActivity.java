...
public class InvestmentDetailBorrowActivity extends BaseNewInvestmentDetailActivity implements View.OnClickListener, SlideDetailsLayout.OnSlideDetailsListener, ViewPager.OnPageChangeListener {

    public LinearLayout ll_pull_up;
    private RelativeLayout mRelativeLayout_back_plan;
    private TextView tv_project_time, tv_once_money, tv_remaining_sum, tv_percent_num, tv_good_rate_second;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            ...
            SystemBarTintManager tintManager = new SystemBarTintManager(InvestmentDetailBorrowActivity.this);
        ...
        //回款计划接口
        if (!StringUtils.isBlank(ACache.get(InvestmentDetailBorrowActivity.this).getAsString(Constant.Investment_Detail_SupplyChain_Relieved_Key))) {
            String mSupplyChain_Relieved_Key = ACache.get(InvestmentDetailBorrowActivity.this).getAsString(Constant.Investment_Detail_SupplyChain_Relieved_Key);
            if (mSupplyChain_Relieved_Key.equals("3")) {
                String bidid = intent.getStringExtra("bidid");
                getPaymentList("3", LoginUserProvider.getUser(InvestmentDetailBorrowActivity.this).getToken(), bidid);
        ...
        MobclickAgent.setScenarioType(InvestmentDetailBorrowActivity.this, MobclickAgent.EScenarioType.E_UM_NORMAL);
    ...
    protected void initView() {
        ...
        setBack(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //埋点判断
                if (!StringUtils.isBlank(ACache.get(InvestmentDetailBorrowActivity.this).getAsString(Constant.Investment_Detail_SupplyChain_Relieved_Key))) {
                    String s = ACache.get(InvestmentDetailBorrowActivity.this).getAsString(Constant.Investment_Detail_SupplyChain_Relieved_Key);
                    if (s.equals("1") || s.equals("2")) {
                        onEvent(InvestmentDetailBorrowActivity.this, "202001_project_details_back_click");
                    } else if (s.equals("3")) {
                        onEvent(InvestmentDetailBorrowActivity.this, "202008_project_details_cj_back_click");
                    }
                }
                finish();
            }
        ...
        tv_good_rate_second = (TextView) findViewById(R.id.tv_good_rate_second);
        ...
        //pagers.get(0);
        LogUtil.e("=====================" + ACache.get(InvestmentDetailBorrowActivity.this).getAsString(Constant.Investment_Detail_SupplyChain_Relieved_Key));
    ...
    private void getData(String from, final String projectid) {
        ...
        client.post(url, params, new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                ...
                ACache.get(InvestmentDetailBorrowActivity.this).put(Constant.InvestmentDetailKey, "");//如果请求网络，先清理本地内存，然后再进行存储
                ACache.get(InvestmentDetailBorrowActivity.this).put(Constant.InvestmentDetailKey, result);
                ...
                if (investmentDetailEntity.getState().equals("4")) {//系统超时
                    String mGesture = LoginUserProvider.getUser(InvestmentDetailBorrowActivity.this).getGesturePwd();
                    if (mGesture.equals("1") && !mGesture.equals("") && mGesture != null) {// 判断是否设置手势密码
                        //设置手势密码
                        Intent intent = new Intent(InvestmentDetailBorrowActivity.this, UnlockGesturePasswordActivity.class);
                        intent.putExtra("overtime", "0");
                        startActivity(intent);
                    } else {
                        //未设置手势密码
                        Intent intent = new Intent(InvestmentDetailBorrowActivity.this, LoginActivity.class);
                        intent.putExtra("overtime", "0");
                        startActivity(intent);
                    }
                    DoCacheUtil util = DoCacheUtil.get(InvestmentDetailBorrowActivity.this);
                    util.put("isLogin", "");
                    ...
                    if (!StringUtils.isBlank(ACache.get(InvestmentDetailBorrowActivity.this).getAsString(Constant.Investment_Detail_SupplyChain_Relieved_Key))) {
                        String s = ACache.get(InvestmentDetailBorrowActivity.this).getAsString(Constant.Investment_Detail_SupplyChain_Relieved_Key);
                        if (s.equals("3")) {
                            ACache.get(InvestmentDetailBorrowActivity.this).put(Constant.Investment_Detail_SupplyChain_Relieved_Key, "3");
                        } else {
                            ACache.get(InvestmentDetailBorrowActivity.this).put(Constant.Investment_Detail_SupplyChain_Relieved_Key, dataJson.getProjectProductType());
                        }
                    }
                    //判断是否显示付款方
                    if (!StringUtils.isBlank(ACache.get(InvestmentDetailBorrowActivity.this).getAsString(Constant.Investment_Detail_SupplyChain_Relieved_Key))) {
                    ...
                    if (!decimalFormat.format(Double.parseDouble(dataJson.getInterestRateIncrease())).equals("0.00")) {
                        ...
                        tv_percent_num.setText(rateDot);
                        String interestRateIncrease = decimalFormat.format(Double.parseDouble(dataJson.getInterestRateIncrease()));
                        tv_good_rate_second.setText("+" + interestRateIncrease + "%");
                    } else {
                        String rateDot = decimalFormat.format(Double.parseDouble(dataJson.getRate()));
                        tv_percent_num.setText(rateDot);
                        tv_good_rate_second.setVisibility(View.GONE);
                    }
                    ...
                    if (proState != null && proState.equals("4")) {
                        tv_interest_time.setText("满标当日计息");//起息时间 dataJson.getLoandate()
                        ...
                        tv_interest_time.setText("满标当日计息");
                    ...
                    ToastUtils.show(InvestmentDetailBorrowActivity.this, investmentDetailEntity.getMessage());
                }
            ...
            public void onFailure(int statusCode, org.apache.http.Header[] headers, byte[] responseBody, Throwable error) {
                ...
                ToastUtils.show(InvestmentDetailBorrowActivity.this, "请检查网络");
    ...
    //判断是否是我的出借 显示上拉详情
    private void upDetail(boolean b) {
        if (!StringUtils.isBlank(ACache.get(InvestmentDetailBorrowActivity.this).getAsString(Constant.Investment_Detail_SupplyChain_Relieved_Key))) {
            String s = ACache.get(InvestmentDetailBorrowActivity.this).getAsString(Constant.Investment_Detail_SupplyChain_Relieved_Key);
            if (s.equals("3")) {
                category_layout.setVisibility(View.VISIBLE);
                if (b)
                    mRelativeLayout_back_plan.setVisibility(View.VISIBLE);
                else
                    mRelativeLayout_back_plan.setVisibility(View.INVISIBLE);
            }
        }
                ...
                try {
                    ...
                    if (repaymentEntity.getState().equals("4")) {//系统超时
                        ...
                        for (int i = 0; i < userPlanList.size(); i++) {
                            ...
                            final LinearLayout layout = (LinearLayout) LayoutInflater.from(InvestmentDetailBorrowActivity.this).inflate(R.layout.activity_my_investment_payment_item, null);
                        ...
                        ToastUtils.show(InvestmentDetailBorrowActivity.this, repaymentEntity.getMessage());
                    }

                } catch (Exception e) {
                    ToastUtils.show(InvestmentDetailBorrowActivity.this, "解析异常");
                }
            }
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.bt_investment://button 出借
                Constant.isboolean = false;
                onEvent(InvestmentDetailBorrowActivity.this, "202007_project_ljcj_tab_click");
                if (LoginUserProvider.getUser(this) != null) {
                    ...
                    if (!StringUtils.isEmpty(doCacheUtil.getAsString("isLogin"))) {
                        if ("isLogin".equals(doCacheUtil.getAsString("isLogin"))) {//去判断 验证token
                            ...
                            initAccountDataToken(LoginUserProvider.getUser(InvestmentDetailBorrowActivity.this).getToken(), "3");
                        }
                    } else {
                        Constant.isboolean = false;
                        login();
