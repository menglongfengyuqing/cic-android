...
public abstract class CalendarView extends View {
    ...
    protected int mClickSelectCircleColor;//点击圆的颜色
    protected int mSelectTodayCircleColor;//今天
    ...
    public CalendarView(Context context) {
        ...
        mClickSelectCircleColor = Attrs.clickSelectCircleColor;
        mSelectTodayCircleColor = Attrs.selectTodayCircleColor;
    ...
    public void setDateTimeAndPoint(DateTime dateTime, List<String> pointList, boolean isInit) {
        this.mSelectDateTime = dateTime;
