 ...
 * @author pc
 */
public class SupplyChainFragment extends Fragment implements OnClickListener {

    private View view;
    private InPossessionFragment mInPossessionFragment;//持有中
    private DaysDueFragment mDaysDueFragment;//30天到期
    ...
    //	public SupplyChainFragment(String type){
    //		this.type = type;
    //	}
    @Override
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.rl_inpossesson:
                ...
                //text_inpossesson_line,text_daysdue_line,text_ended_line;
