...
public class CircleScaleView extends View {
        ...
        for (int i = 0;i<n;i++){
            ...
            switch (attr){
                case R.styleable.CircleScaleView_lifeCostColor:
                    mLifeCostColor = array.getColor(attr, Color.parseColor("#ffb312"));
                    break;
                case R.styleable.CircleScaleView_trafficCostColor:
                    trafficCostColor = array.getColor(attr, Color.parseColor("#00aeef"));
                    break;
                case R.styleable.CircleScaleView_communicateCostColor:
                    mCommunicationCostColor = array.getColor(attr, Color.parseColor("#ff0000"));
                    break;
                case R.styleable.CircleScaleView_entertainmentCostColor:
                    mEntertainmentColor = array.getColor(attr, Color.parseColor("#00cbbb"));
                    break;
    ...
    public void setCostPercent(float liftCost,float communicateCost,float trafficCost,float entertainmentCost){
