...
public class RollViewPager extends ViewPager {
    ...
    public interface OnPageClick {
        public abstract void onClick(String url,String title);
    }
    ...
    public RollViewPager(Context context, final LinearLayout ll_dot, TextView tv_title, final PagerBean bean, OnPageClick onPageClick) {
        super(context);
    ...
    class MyAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, final int position) {
            ...
            // bitmapUtils.display(imageView, "https://erp.cicmorgan.com/erp/userfiles/sharedFiles/images/photo/2018/05/1.jpg");
                    ...
                    switch (event.getAction()) {
                        ...
                        case MotionEvent.ACTION_UP:
                            ...
                            if (System.currentTimeMillis() - downTime < 500 && Math.abs((int) event.getX() - downX) <= 5) {
                                ...
                                //回调相关
                                onPageClick.onClick(bean.textUrls.get(position % bean.textUrls.size()),bean.titles.get(position % bean.titles.size()));
                            }
                            break;
    ...
    private void initDot(LinearLayout ll_dot) {
        ...
        for (int i = 0; i < bean.imgUrls.size(); i++) {
            ...
            LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(
                    CommonUtil.dip2px(context, 12),
                    CommonUtil.dip2px(context, 1));
            layoutParams.setMargins(
                    CommonUtil.dip2px(context, 5), 0,
                    CommonUtil.dip2px(context, 5), 0);
