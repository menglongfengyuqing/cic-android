...
public class NumberProgressBar extends View {
    ...
    private void calculateDrawRectFWithoutProgressText() {
        ...
        mReachedRectF.right = (float) ((getWidth() - getPaddingLeft() - getPaddingRight()) / (getMax() * 1.0f) * getProgress() + getPaddingLeft());
    ...
    private void calculateDrawRectF() {
        ...
        if (getProgress() == 0) {
            ...
            mReachedRectF.left = getPaddingLeft();
            mReachedRectF.top = getHeight() / 2.0f - mReachedBarHeight / 2.0f;
            mReachedRectF.right = (float) ((getWidth() - getPaddingLeft() - getPaddingRight()) / (getMax() * 1.0f) * getProgress() - mOffset + getPaddingLeft());
            mReachedRectF.bottom = getHeight() / 2.0f + mReachedBarHeight / 2.0f;
