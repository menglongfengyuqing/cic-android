...
public class CustomToastUtils {
    ...
    public CustomToastUtils(Context context, int layoutId, String msg) {
        message = msg;
    ...
    public CustomToastUtils(Context context, String msg) {
        message = msg;
        LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        //自定义布局
        View view = inflater.inflate(R.layout.activity_toast_util, null);
        //自定义toast文本
        mTextView = (TextView) view.findViewById(R.id.toast_msg);
        mTextView.setText(msg);
        Log.i("ToastUtil", "Toast start...");
    ...
    public void show(int duration) {
        timeCount = new TimeCount(duration, 3000);
        Log.i("ToastUtil", "Toast show...");
        if (canceled) {
            timeCount.start();
            canceled = false;
    ...
    private class TimeCount extends CountDownTimer {
        ...
        public void onTick(long millisUntilFinished) {
            mTextView.setText(message/* + ": " + millisUntilFinished / 3000 + "s后消失"*/);
        }
